...
public class SpUtils {
	...
	private static String mPreferencesName = "share_preference_fzm";
	...
	public static <T> void setDataList(String key, List<T> datalist) {
		...
		SpUtils.putString(App.getContext(), key, strJson);
	}
	...
	public static <T> List<T> getDataList(String key, Class<T> cls) {
		...
		String strJson = SpUtils.getString(App.getContext(), key, null);
